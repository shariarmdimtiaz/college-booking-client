    ...
    <footer style={containerStyles}>
      ...
      <div className="container mx-auto py-12 px-4">
        <div className="pb-9 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4">
          ...
          <div>
            <h3 className="text-lg font-bold mb-4 text-left ps-5">College</h3>
          ...
          <div>
            <h3 className="text-lg font-bold mb-4 text-left ps-5">Services</h3>
            <ul className="list-none text-left ps-5">
              <li className="mb-2">
                <a href="#">Booking</a>
              </li>
        ...
        <div className="container mx-auto px-4 md:flex justify-center">
          <div>
            <p className="text-center">
              @2023 Online College Booking System. All Rights Reserved
            </p>
          </div>
          <div>
            <p className="text-center">
              Powered by <span className="font-extrabold">College Booking</span>
            </p>
          </div>
        </div>
      </div>
